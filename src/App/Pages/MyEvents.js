...
const MyEvents = () => {
  ...
  const renderEvents = () => {
    ...
    return events.map((e, i) => (
      <EventCard rounded="md" key={i} view="explore" {...e} />
    ));
  };
  ...
  return (
    <FadeAnimation fadeIn>
      <div className="my-events relative flex flex-col space-y-8 w-full px-10 text-whites-light">
        {/* Stats */}
        <div className="absolute bottom-full self-end w-64 px-2 rounded-md flex items-center bg-grays-dark shadow-sm">
          <div className="w-full py-2 flex justify-around items-center">
            {isLoading && isEmpty(stats) ? (
              <div className="text-2xs py-2">
        ...
        <div className="text-whites-light text-tiny font-bold pl-1">
          <div className="header -mt-8 text-sm text-whites-light font-bold p-3 -ml-2.5 flex space-x-3 items-center">
        ...
        {isFiltering && (
          <div className="flex flex-col flex-grow w-full space-y-1.5">
            <SecondaryCard
              secondaryAction={
                <Button
                  ...
                  className="text-2xs font-light opacity-70 pr-2"
                  text="Discard"
                  textOnly
                  variant="light"
                />
              ...
              primaryAction={
                <Button
                  ...
                  className="text-2xs border border-blacks-dark border-opacity-25 py-2"
                  variant="light"
                  text="Apply filters"
                  icon={
                    <svg
            ...
            >
              <div className="relative flex flex-col space-y-2.5 justify-center text-whites-light px-2">
                {/* Title */}
                <div className="flex items-center space-x-1 text-2xs italic text-whites-dark tracking-wide opacity-70">
                  <span>narrow search by date, event status or both</span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <span
                  ...
                  className="absolute z-10 -top-3.5 -right-1 cursor-pointer opacity-70 hover:opacity-100"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-4 w-4 text-whites-light"
                    viewBox="0 0 20 20"
                    fill="currentColor"
                  >
                    <path
            ...
            {/* Tags */}
            <div className="flex space-x-2 text-whites-dark text-2xs w-full pb-2">
              <div className="text-2xs pl-1 text-whites-light">Tags: </div>
              {/* Dates */}
        ...
        <div className="flex flex-grow flex-col w-full space-y-8 justify-start items-center px-5">
          {isLoading ? (
...
const StatusFilter = ({
  ...
  return (
    <div className="flex flex-col space-y-2">
      ...
      <div className="relative pl-2 flex items-center space-x-6 justify-start">
        <div
          ...
          } rounded-full text-2xs flex space-x-1 items-center`}
        >
          <span>Ongoing</span>
          {formikCtx.values.status.includes(0) && (
        ...
        <div className="absolute top-full pt-1 transform left-6">
          {!fetch_configs.filters.status ||
          !fetch_configs.filters.status?.length ? (
            <div className="text-2xs pl-1 text-primary-dark">Required</div>
          ) : null}
        </div>
      </div>
    </div>
    ...
    <div className="flex flex-col space-y-2">
      ...
      <div className="flex items-center space-x-2 justify-evenly">
        <div className="flex flex-col justify-center items-center">
          <span className="text-2xs font-light text-whites-dark">From</span>
        ...
        <div className="flex flex-col justify-center items-center">
          <span className="text-2xs font-light text-whites-dark">To</span>
          <ThemeProvider theme={denseDatetimeTheme}>
            <div className="text-xs">
              <Datetime
                format="MM/DD/YYYY"
