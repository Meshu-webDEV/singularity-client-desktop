...
export const MODAL_SET_SCROLLABLE = "MODAL_SET_SCROLLABLE";
...
export const SET_DASHBOARD_SHOULD_UPDATE = "SET_DASHBOARD_SHOULD_UPDATE";
...
export const SET_EVENTS_LIVE_EVENTS_IS_LOADING =
  "SET_EVENTS_LIVE_EVENTS_IS_LOADING";
export const EVENTS_SET_LIVE_EVENTS = "EVENTS_SET_LIVE_EVENTS";
...
export const SET_NEWEVENT_IS_TEMPLATE_SET = "SET_NEWEVENT_IS_TEMPLATE_SET";
...
export const PUSH_BREADCRUMBS = "PUSH_BREADCRUMBS";
